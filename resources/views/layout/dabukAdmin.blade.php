...
<div class="row mt-5">
    ...
    <div class="modal fade" id="editBukuModal" tabindex="-1" aria-labelledby="editBukuModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="editForm" action="{{ route('admin.databuku.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
...
<script>
    document.querySelectorAll('.edit-button').forEach(button => {
        button.addEventListener('click', function() {
            ...
            form.action = `/admin/databuku/${bookId}`; // Update action URL
            ...
            document.getElementById('pdf_url_edit').value = this.getAttribute('data-pdf_url');
