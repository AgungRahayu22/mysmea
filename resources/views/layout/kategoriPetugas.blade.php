            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="categoryTable">
                        ...
                        <tbody>
                            @foreach ($categories as $petugas => $category)
                                <tr>
                                    <td>{{ $petugas + 1 }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('petugas.kategori.destroy', $category->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
...
document.addEventListener("DOMContentLoaded", function() {
    document.querySelectorAll('.edit-button').forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('editCategoryForm').action = "/petugas/katagori/" + id;
        });
    });
});
</script>
